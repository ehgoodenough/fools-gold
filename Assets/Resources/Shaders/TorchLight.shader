...
////// Emissive:
                ...
                float3 emissive = (_Color.rgb*pow((cos((saturate((node_4204 + ( (distance(i.posWorld.rgb,objPos.rgb) - _Distance0) * (1.0 - node_4204) ) / (_Distance1 - _Distance0)))*3.141592654))*0.5+0.5),lerp(_Power0,_Power1,(sin((node_3175.g*_Frequency))*0.5+0.5))));
